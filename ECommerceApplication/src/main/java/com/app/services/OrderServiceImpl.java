...
public class OrderServiceImpl implements OrderService {
  ...
  @Override
  public OrderDTO placeOrder(String email, Long cartId, String paymentMethod, String memberCode) {
    ...
    if (!user.getMemberCode().equals(memberCode)) {
      throw new APIException("Membership code is invalid");
    }

    double discountedPrice = (1 - AppConstants.MEMBER_DISCOUNT_PERCENTAGE / 100) * cart.getTotalPrice();
    ...
    for (CartItem cartItem : cartItems) {
      ...
      orderItem.setProduct(cartItem.getProduct());
      orderItem.setQuantity(cartItem.getQuantity());
      orderItem.setDiscount(AppConstants.MEMBER_DISCOUNT_PERCENTAGE);

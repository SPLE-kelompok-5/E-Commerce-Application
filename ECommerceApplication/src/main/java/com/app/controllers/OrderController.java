...
public class OrderController {
    ...
    @PostMapping("/public/users/{email}/carts/{cartId}/payments/creditcard/order")
    public ResponseEntity<OrderDTO> orderProductsWithCreditCard(
            @PathVariable String email, 
            @PathVariable Long cartId, 
            @Valid @RequestBody CreditCardDTO creditCardDTO) {
        OrderDTO order = orderService.placeOrderWithCreditCard(email, cartId, creditCardDTO);
